...
- **[JSON 字段说明文档](docs/manual/JsonField.MD)** - 详细的配置字段说明
- **[后台输入功能使用指南](docs/manual/BackgroundInput.MD)** - 后台输入功能的完整使用指南
- **[项目结构文档](docs/develop/Structure.MD)** - 项目代码结构说明
- **[更新日志](docs/CHANGELOG.MD)** - 版本更新记录和新功能说明
